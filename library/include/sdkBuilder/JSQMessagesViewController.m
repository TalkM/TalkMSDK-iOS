...
//    self.collectionView.backgroundColor = HexColor(0xf5f6f1);
    self.collectionView.backgroundColor = HexColor(0xffffff);  //talkmdev
    ...
    self.inputToolbar.contentView.textView.layer.cornerRadius = 15;  //talkm txtReply
...
- (BOOL)isOutgoingMessage:(id<JSQMessageData>)messageItem
{
    ...
    ShareData *sdata = [ShareData ShareDataAction];
    if ([sdata.voidCheckingForAdvertisement isEqualToString:@"no"]){
