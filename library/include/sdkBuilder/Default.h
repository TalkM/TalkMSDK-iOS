...
#define SSO_API_URL    @"https://{1}.alias.talkm.com/sso?format=json&ostype=2&imsdkname=im_visitor_ios&imsdkver=b20170706"  //imsetting info

//#define SSO_API_URL    @"https://{1}.alias.talkm.dev/sso?format=json&ostype=2&imsdkname=im_visitor_ios&imsdkver=b20170706"  //imsetting dev
//#define SSO_API_URL    @"https://{1}.alias.talkm.dev/sso?format=json"                  // dev

// ** IM的服务器根地址
//#define IM_SERVER_ADDR @"192.168.1.190"   // 苏州内网测试服务器
#define IM_SERVER_ADDR @"101.78.17.229" // TODO TalkM Alpha测试服务器  //info
//#define IM_SERVER_ADDR @"10.1.1.64" // TODO TalkM Alpha测试服务器  //dev

#define IM_SERVER_PORT 7901

// ** HTTP Rest的服务器根地址
//#define APP_ROOT_URL @"192.168.1.190:8080"    // 苏州内网测试服务器
//#define APP_ROOT_URL @"101.78.17.229:8080"  // TODO TalkM Alpha测试服务器  //info
#define APP_ROOT_URL @"www.talkm.com:8080"  // TODO TalkM Alpha测试服务器  //com
//#define APP_ROOT_URL @"www.talkm.dev:8080"  // TODO TalkM Alpha测试服务器  //dev
//#define APP_ROOT_URL @"10.1.1.64:8080"  // TODO TalkM Alpha测试服务器  //dev

// ** HTTP Rest普通数据服务端的根URL
#define SERVER_CONTROLLER_URL_ROOT            @"https://"APP_ROOT_URL@"/TalkM_IMHttpServer/"
// ** HTTP Rest用户2进制数据下载Servlet地址
#define BBONERAY_DOWNLOAD_CONTROLLER_URL_ROOT @"https://"APP_ROOT_URL@"/TalkM_IMHttpServer/BinaryDownloadController"

// ** HTTP Rest 图片消息的图片文件上传Servlet地址
#define MSG_IMG_UPLODER_URL_ROOT              @"https://"APP_ROOT_URL@"/TalkM_IMHttpServer/MsgImageUploader"
