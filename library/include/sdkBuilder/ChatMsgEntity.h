...
typedef NS_ENUM(NSInteger, MsgType){
    ...
    MsgType_END_CONV  = 19,
    MsgType_END_CONV_RETURN  = 20,   //the bubble msg with alert icon
...
@property (nonatomic, assign) NSString *rateStatus;// = SendStatus.sending;
...
+ (ChatMsgEntity *)createChatMsgEntity_RATE:(NSString *)nickName withContent:(NSString *)message rateStatus:(NSString *)rateStatus respondText:(NSString *)respondText;
+ (ChatMsgEntity *)createChatMsgEntity_RATE:(NSString *)nickName withContent:(NSString *)message andTime:(NSDate *)time rateStatus:(NSString *)rateStatus respondText:(NSString *)respondText;
+ (ChatMsgEntity *)createChatMsgEntity_END_CONV_BUBBLE:(NSString *)nickName withContent:(NSString *)message andTime:(NSDate *)time rateStatus:(NSString *)rateStatus respondText:(NSString *)respondText;
...
+ (ChatMsgEntity *)createChatMsgEntity_ByType:(NSString *)nickName withContent:(NSString *)message andTime:(NSDate *)time rateStatus:(NSString *)rateStatus respondText:(NSString *)respondText msgType:(int)msType avatar:(UIImage *)avatar;
