...
const CGFloat kJSQMessagesCollectionViewCellLabelHeightDefault = 8.0f;  //talkmdev - cell gap height, bubble gap
...
//        _messageBubbleLeftRightMargin = 0.0f;   // while set to 0, the (CS tail)/(visitor head) will diplay full length
    }
...
//    _messageBubbleTextViewTextContainerInsets = UIEdgeInsetsMake(7.0f, 14.0f, 7.0f, 0.0f);
...
- (CGFloat)itemWidth
{
//    NSLog(@"CollectionView.frame : %f", CGRectGetWidth(self.collectionView.frame));
//    NSLog(@"sectionInset.left : %f", self.sectionInset.left);
//    NSLog(@"sectionInset.right : %f", self.sectionInset.right);
//    NSLog(@"JSQmessageCollectionViewFlowLayout itemWidth : %f", CGRectGetWidth(self.collectionView.frame) - self.sectionInset.left - self.sectionInset.right);
...
- (void)jsq_configureMessageCellLayoutAttributes:(JSQMessagesCollectionViewLayoutAttributes *)layoutAttributes
{
    ...
    int cancelOutgoingSize = 0;
    
    layoutAttributes.messageBubbleContainerViewWidth = messageBubbleSize.width - cancelOutgoingSize;
    
//    NSLog(@"*******message bubble size : %f", layoutAttributes.messageBubbleContainerViewWidth);
    
    //layoutAttributes.textViewFrameInsets = self.messageBubbleTextViewFrameInsets ;
    layoutAttributes.textViewFrameInsets = UIEdgeInsetsZero ;
    
//    NSLog(@"*******message textViewFrameInsets size : %f", layoutAttributes.textViewFrameInsets);
    
    layoutAttributes.textViewTextContainerInsets = self.messageBubbleTextViewTextContainerInsets;
//    layoutAttributes.textViewTextContainerInsets = UIEdgeInsetsZero;
    
//    NSLog(@"*******message textViewTextContainerInsets size : %f", layoutAttributes.textViewTextContainerInsets);
...
//    layoutAttributes.outgoingAvatarViewSize = CGSizeMake(30, 0);
