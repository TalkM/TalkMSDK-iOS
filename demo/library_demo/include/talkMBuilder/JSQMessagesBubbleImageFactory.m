...
- (instancetype)init
{
    ...
    return [self initWithBubbleImage:[UIImage imageNamed:@"ic_chatbubble2"] capInsets:UIEdgeInsetsZero];  //talkmdev custom bubble
    
    //talkmdev bubble shape
//    return [self initWithBubbleImage:[UIImage jsq_bubbleCompactImage] capInsets:UIEdgeInsetsZero];  //origin
    
//    return [self initWithBubbleImage:[UIImage jsq_bubbleCompactTaillessImage] capInsets:UIEdgeInsetsZero];
    
//    return [self initWithBubbleImage:[UIImage jsq_bubbleRegularStrokedImage] capInsets:UIEdgeInsetsZero]; //transperant with tail
    
//        return [self initWithBubbleImage:[UIImage jsq_bubbleRegularStrokedTaillessImage] capInsets:UIEdgeInsetsZero]; //transperant with tailless
