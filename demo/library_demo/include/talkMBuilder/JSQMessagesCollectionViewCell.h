...
- (void)messagesCollectionViewCellDidTapResend:(JSQMessagesCollectionViewCell *)cell;
...
/**
 *  Returns the label that is pinned just above the messageBubbleImageView, and below the cellTopLabel.
 *  This label is most commonly used to display the message time stamp.
 */
@property (weak, nonatomic, readonly) JSQMessagesLabel *messageBubbleTimeStampLabel;
...
@property (weak, nonatomic, readonly) UIView *uiCustomView;
