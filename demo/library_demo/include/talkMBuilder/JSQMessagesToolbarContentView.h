...
@property (weak, nonatomic) UIButton *leftBarButton2Item;
@property (weak, nonatomic) UIButton *left3BarButtonItem;
...
@property (assign, nonatomic) CGFloat left3BarButtonItemWidth;
...
@property (assign, nonatomic) CGFloat left3ContentPadding;
...
@property (weak, nonatomic, readonly) UIView *left3BarButtonContainerView;
...
@property (weak, nonatomic) UIButton *right2BarButtonItem;
@property (weak, nonatomic) UIButton *right3BarButtonItem;  //for enlarge button press area
...
@property (assign, nonatomic) CGFloat right2BarButtonItemWidth;
@property (assign, nonatomic) CGFloat right3BarButtonItemWidth; //for enlarge button press area
...
@property (assign, nonatomic) CGFloat right2ContentPadding;
@property (assign, nonatomic) CGFloat right3ContentPadding;  //for enlarge button press area
...
@property (weak, nonatomic, readonly) UIView *right2BarButtonContainerView;
@property (weak, nonatomic, readonly) UIView *right3BarButtonContainerView; //for enlarge button press area
