...
+ (UIButton *)defaultAccessoryButton2Item
{
    ...
    UIImage *highlightedImage = [UIImage imageNamed:@"ic_im-image-blue"];//[accessoryImage jsq_imageMaskedWithColor:[UIColor darkGrayColor]];
...
+ (UIButton *)defaultSendButtonItem
{
    ...
    UIImage *normalImage = [UIImage imageNamed:@"ic_send_small"];// js
...
//                                  30.0f);  //0
    ...
    sendButton.backgroundColor = [libsdk colorFromHexString2:sdata.themeColor]; //talkmdev -send button circle  //[UIColor clearColor];
