...
//        if (title == nil){
//            //make it vertical center when no title
//            messageLabel.frame = CGRectMake(0.0, 0.0, expectedSizeMessage.width, 5);
//        }
//        else{
...
//        titleWidth = titleHeight = titleTop = titleLeft = 0;
        titleWidth = titleHeight = titleTop = titleLeft = 4.0;   //talkmdev = if no title. margin = 4
    }
